...
import jdev.modulos.modulo09.constantes.StatusAluno;

//AULA - Separando as listas com HashMap
public class ListaAprovadoHashMap {

	public static void main(String[] args) {

		List<Aluno> alunos = new ArrayList<>();
		
		//É uma lista que dentro de temos uma chave que identifica uma sequência de valores também
